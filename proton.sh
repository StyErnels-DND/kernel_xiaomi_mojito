...
git clone --depth=1 https://github.com/Styrofoam-Kernel/AnyKernel3.git --branch mojito  AnyKernel
echo "Done"
...
function zipping() {
    cd AnyKernel || exit 1
    zip -r9 Styrofoam-x-mojito-${TANGGAL}.zip *
    cd ..
}
sticker
sendinfo
